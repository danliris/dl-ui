...
export class App {
  ...
  configureRouter(config, router) { 
    ...
    var routes = [
      ...
      { route: 'po/reports/periode/unit',     name: 'purchase-order-reports-periode-unit', moduleId: './modules/purchasing/reports/purchase-order-report/unit-report/index',     nav: true, title: 'Rekap Total Pembelian per Unit per Periode', settings: { group:"purchasing", roles:["purchasing"] }},
      { route: 'po/reports/periode/category', name: 'purchase-order-reports-periode-category', moduleId: './modules/purchasing/reports/purchase-order-report/category-report/index', nav: true, title: 'Rekap Total Pembelian per Kategori per Periode', settings: { group:"purchasing", roles:["purchasing"] }},
      ...
      { route: 'receipt-note/unit',   name: 'receipt-note-unit',                 moduleId: './modules/purchasing/unit-receipt-note/index',                                nav: true, title: 'Bon Penerimaan Unit', settings: { group:"purchasing", roles:["purchasing"] }},
    ];
