...
export class App {
  ...
  configureRouter(config, router) {
    ...
    var routes = [ 
      ...
      { route: 'production/spinning/winding/winding-quality-sampling',       name: 'winding-quality-sampling',      moduleId: './modules/production/spinning/winding/winding-quality-sampling/index',                 nav: true, title: 'Quality Hasil Produksi Spinning', settings: { group:"production", roles:["purchasing"] }},
      { route: 'production/spinning/winding/reports/winding-quality-sampling-report',       name: 'winding-quality-sampling-report',      moduleId: './modules/production/spinning/winding/reports/winding-quality-sampling-report/index',                 nav: true, title: 'Laporan Quality Hasil Produksi Spinning', settings: { group:"production", roles:["purchasing"] }},
    ];
