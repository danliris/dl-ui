...
export class App {
  ...
  configureRouter(config, router) {
    ...
    var routes = [ 
      ...
      { route: 'production/spinning/winding/winding-production-output',           name: 'winding-production-output',                moduleId: './modules/production/spinning/winding/winding-production-output/index',    nav: true,  title: 'Output Hasil Produksi Spinning',settings: { group:"purchasing",   roles:["purchasing"] }},
