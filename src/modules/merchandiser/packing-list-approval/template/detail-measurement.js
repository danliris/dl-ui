...
export class measurement {
    ...
    activate(context) {
        ...
        this.cmb=(this.data.length * this.data.width * this.data.height * this.data.cartonsQuantity / 1000000).toLocaleString('en-EN', { minimumFractionDigits: 3, maximumFractionDigits: 3 }) || "0";
    }
