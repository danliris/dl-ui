    ...
    if (!this.create)
      {
        ...
        //console.log(this.selectedBookingOrder);
 ...
 @bindable selectedBookingOrder;
  ...
  get calculatedRateOTL1() {
    ...
    if (this.data.CCType == "SUBCON KELUAR") {
      switch (this.data.SubconType) {
        case "SUBCON SEWING":
          calculatedRateOTL1 = this.data.SMV_Total ? this.data.OTL1.Value * (this.data.SMV_Cutting + this.data.SMV_Finishing) : 0;
          break;
        case "SUBCON CUTTING SEWING":
          calculatedRateOTL1 = this.data.SMV_Total ? this.data.OTL1.Value * (this.data.SMV_Finishing) : 0;
          break;
      }
    } else {
      calculatedRateOTL1 = this.data.SMV_Total ? this.data.OTL1.Value * this.data.SMV_Total : 0;
    }
  ...
  get calculatedRateOTL2() {
    ...
    if (this.data.CCType == "SUBCON KELUAR") {
      switch (this.data.SubconType) {
        case "SUBCON SEWING":
          calculatedRateOTL2 = this.data.SMV_Total ? this.data.OTL2.Value * (this.data.SMV_Cutting + this.data.SMV_Finishing) : 0;
          break;
        case "SUBCON CUTTING SEWING":
          calculatedRateOTL2 = this.data.SMV_Total ? this.data.OTL2.Value * (this.data.SMV_Finishing) : 0;
          break;
      }
    } else {
      calculatedRateOTL2 = this.data.SMV_Total ? this.data.OTL2.Value * this.data.SMV_Total : 0;
    }
