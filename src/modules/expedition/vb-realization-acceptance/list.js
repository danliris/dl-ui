...
export class List {
    ...
    columns = [
        {
            field: 'UPODate', title: 'Tanggal Masuk Verifikasi', formatter: function (value, data, index) {
                return moment(value).format('DD MMM YYYY');
            },
        },
        { field: 'UnitPaymentOrderNo', title: 'No VB' },
        {
            field: 'DueDate', title: 'Tanggal Realisasi VB', formatter: function (value, data, index) {
                return moment(value).format('DD MMM YYYY');
            },
        },
        { field: 'InvoiceNo', title: 'Nomor Realisasi VB' },
        { field: 'InvoiceNo', title: 'Tipe VB' },
        { field: 'InvoiceNo', title: 'Pemohon VB' },
