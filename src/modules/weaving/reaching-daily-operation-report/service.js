...
const serviceUri = 'weaving/daily-operations-reaching-machine';
...
export class Service extends RestService {
    ...
    generateExcel(info) {
        var endpoint = `${serviceUri}/report-download?fromDate=${info.fromDate}&toDate=${info.toDate}&shift=${info.shift}`;
        var query = '';
        ...
        if (query !== '')
        endpoint = `${serviceUri}/report-download?${query}`;
