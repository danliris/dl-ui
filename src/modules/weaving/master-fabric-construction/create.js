...
export class Create {
  ...
  saveCallback(event) {
    ...
    // console.log(this.data.ItemsWarp);
    // this.data.ItemsWarp.forEach(warpDatum => {
    //   if (
    //     warpDatum.quantity == null ||
    //     warpDatum.quantity == undefined ||
    //     warpDatum.quantity == ""
    //   ) {
    //     console.log(this.error);
    //     this.error.ItemsWarp.quantity = "Kuantitas Lusi Harus Diisi";
    //     index++;
    //   }
    // });

    // console.log(this.data.ItemsWeft);
    // this.data.ItemsWeft.forEach(weftDatum => {
    //   if (
    //     weftDatum.quantity == null ||
    //     weftDatum.quantity == undefined ||
    //     weftDatum.quantity == ""
    //   ) {
    //     console.log(this.error);
    //     this.error.ItemsWeft.quantity = "Kuantitas Pakan Harus Diisi";
    //     index++;
    //   }
    // });
