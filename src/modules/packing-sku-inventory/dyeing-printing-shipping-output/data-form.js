...
let ShippingAreaLoader = require("../../../loader/output-shipping-dp-loader");
...
export class DataForm {
  ...
  bind(context) {
    ...
    if (this.data.type == "OUT") {
      ...
      if (this.data.shippingItems) {
        this.data.adjShippingProductionOrders = this.data.shippingItems;
      }
  ...
  selectedShippingChanged(n, o) {
    if (this.selectedShipping) {
      ...
      if (this.selectedShipping.shippingItems) {
        this.data.displayShippingProductionOrders = this.selectedShipping.shippingItems.filter(
        ...
        this.data.inputShippingId == this.selectedShipping.id;
        this.data.shippingCode = this.selectedShipping.shippingCode;
      }
      if (this.ItemsCollection) {
        this.ItemsCollection.bind();
      }
  ...
  shippingQuery = {
    ...
    "DPShippingOutputItems.Any(HasNextAreaDocument == false)":true
  };
  @bindable selectedDO;
