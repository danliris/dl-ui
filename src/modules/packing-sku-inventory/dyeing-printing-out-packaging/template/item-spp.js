...
@inject(Service, BindingEngine, DataForm)
export class ItemSPP {


    constructor(service, bindingEngine, dataForm) {
    ...
    itemColumnsGroup = ["","Buyer", "Qty Order", "Unit", "Material", "Warna", "Motif",  "Grade", "Satuan", "Saldo", "QTY Keluar",""];
    ...
    selectedProductionOrderChanged(newValue, oldValue) {
        ...
        this.data.PackingProductionOrderList = this.selectedProductionOrder.productionOrderList;
