...
export class List {
    ...
    activate(params) {
        if (params.sdate != null || params.edate != null) {
            ...
            if (this.dateFrom == undefined && this.dateTo == undefined)
                uri = this.service.getDataSplnoDate();
            else
                uri = this.service.getDataSpl(this.dateFrom, this.dateTo);
    ...
    view(data, sdate, edate) {
        this.router.navigateToRoute('view', { id: data._id._id, supplier: data._id.name, sdate: this.dateFrom, edate: this.dateTo });
   }
