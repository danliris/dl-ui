...
export class List {
  ...
  selectedComodityChanged(newValue) {
    if (newValue) {
      this.LeftoverComodity = newValue;
    }
  }
  ...
  columns = [
    ...
    {
      field: "ComodityUnitCode",
      title: "Kode Komoditi Unit",
      sortable: false,
      width: "15%",
    },
    {
      field: "ComodityCode",
      title: "Kode Komoditi Gudang Sisa",
      sortable: false,
      width: "15%",
    },
    {
      field: "Comodity",
      title: "Komoditi Gudang Sisa",
      sortable: false,
      width: "15%",
    },
    {
      field: "BeginingbalanceQty",
      title: "Saldo Awal",
      sortable: false,
      width: "3%",
    },
    {
      field: "QuantityReceipt",
      title: "Penerimaan",
      sortable: false,
      width: "3%",
    },
    {
      field: "QuantityExpend",
      title: "Pengeluaran",
      sortable: false,
      width: "3%",
    },
  ...
  loader = (info) => {
    ...
    let args = {
      ...
      ro: this.ro ? this.ro : "",
      comodityCode: this.LeftoverComodity ? this.LeftoverComodity.Code : "",
    };
