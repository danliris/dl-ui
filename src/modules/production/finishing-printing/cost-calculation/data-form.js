...
export class DataForm {
  ...
  machineOptions = {};
  costCalculationFP_MaterialsInfo = {
    columns: [
    ...
    onAdd: function () {
      this.data.CostCalculationFP_Materials.push({
        Quantity: this.data.Quantity,
        GreigeAllowance: this.data.GreigeAllowance,
        ChemicalAllowance: this.data.ChemicalAllowance,
        Rate: this.data.Rate,
  ...
  unitQuery = { "DivisionName": "DYEING & PRINTING" }
  async bind(context) {
    ...
    this.greigeAllowance = this.data.GreigeAllowance ? this.data.GreigeAllowance : 0;
    this.chemicalAllowance = this.data.ChemicalAllowance ? this.data.ChemicalAllowance : 0;
    ...
    if (this.data.CostCalculationFP_Materials) {
      this.data.CostCalculationFP_Materials.forEach(item => {
        item.Quantity = this.data.Quantity;
        item.GreigeAllowance = this.data.GreigeAllowance;
        item.ChemicalAllowance = this.data.ChemicalAllowance;
  ...
  @computedFrom("error.CostCalculationFP_MaterialTable")
  get hasError() {
    return (this.error.CostCalculationFP_MaterialTable ? this.error.CostCalculationFP_MaterialTable.length : 0) > 0;
  }
  ...
  @bindable greigeAllowance;
  greigeAllowanceChanged(newValue) {
    this.data.GreigeAllowance = newValue;
    if (this.data.CostCalculationFP_Materials) {
      this.data.CostCalculationFP_Materials.forEach(item => {
        item.GreigeAllowance = this.data.GreigeAllowance;
      })
  ...
  @bindable chemicalAllowance;
  chemicalAllowanceChanged(newValue) {
    this.data.ChemicalAllowance = newValue;
    if (this.data.CostCalculationFP_Materials) {
      this.data.CostCalculationFP_Materials.forEach(item => {
        item.ChemicalAllowance = this.data.ChemicalAllowance;
      })
