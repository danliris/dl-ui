...
export class DataForm {
    ...
    @computedFrom('data.RPM', 'data.Eff', 'data.D')
    get CapacityPerShift() {
        let CapacityPerShift = ((60 * 8 * this.data.RPM * (this.data.Eff/100) * 2)/(768 * 400 * (50 / this.data.D))).toFixed(2);
