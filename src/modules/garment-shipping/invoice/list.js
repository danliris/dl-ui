...
export class List {
    ...
    context = ["detail","Cetak PDF Invoice", "Cetak PDF Invoice CMT", "Cetak PDF Invoice W/ Kop", "Cetak PDF Invoice CMT W/ Kop", "Cetak Excel Invoice", "Cetak Excel Invoice CMT",]
