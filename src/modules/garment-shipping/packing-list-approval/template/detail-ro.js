...
export class Item {
    ...
    async activate(context) {
        ...
        if (this.data.details) {
          this.data.details.forEach((detail)=>{
            if (detail.cartonQuantity && detail.quantityPCS) {
              this.totalQty += detail.cartonQuantity * detail.quantityPCS;
              this.totalCtn += detail.cartonQuantity;
            }
          });
        }
        this.data.amount = 0;
        ...
        // this.subGrossWeight+= this.sumSubTotal(0);
        // this.subNetWeight+= this.sumSubTotal(1);
        // this.subNetNetWeight+= this.sumSubTotal(2);
