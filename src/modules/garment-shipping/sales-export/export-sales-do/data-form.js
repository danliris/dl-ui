...
const SalesNoteLoader = require('../../../../loader/garment-shipping-export-sales-note-loader');
...
export class DataForm {
    ...
    bind(context) {
        ...
        if (this.data.id) {
            this.selectedSalesNote = {
                noteNo: this.data.exportSalesNoteNo
            };
        }
    }
    ...
    selectedSalesNoteChanged(newValue) {
        ...
        this.data.exportSalesNoteNo = null;
        this.data.exportSalesNoteId = 0;
        this.data.buyer = null;
        this.data.items.splice(0);
        if (newValue) {
            this.data.exportSalesNoteNo = newValue.noteNo;
            this.data.exportSalesNoteId = newValue.id;
            this.data.buyer = newValue.buyer;
            this.service.salesNoteGetById(this.data.exportSalesNoteId)
                .then(salesNote => {
                    for (var item of salesNote.items) {
                        let doItem = {};
                        doItem.exportSalesNoteItemId = item.id;
