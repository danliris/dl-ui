...
export class List {
	...
	columns = [
		{ field: "ServiceSampleShrinkagePanelNo", title: "No Sample BB Shrinkage / Panel" },
		{ field: "UnitExpenditureNo", title: "No BUK" },
		{
			field: "ServiceSampleShrinkagePanelDate", title: "Tgl Sample BB Shrinkage / Panel", formatter: function (value, data, index) {
