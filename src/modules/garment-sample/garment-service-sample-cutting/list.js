...
export class List {
    ...
    columns = [
        { field: "SampleNo", title: "No Sample Jasa Komponen" },
        { field: "SamplenType", title: "Jenis Sample" },
        { field: "UnitName", title: "Unit Asal" },
        { field: "Items", title: "RO"},
       // { field: "TotalQuantity", title: "Jumlah Out", sortable: false},
        { field: "SampleDate", title: "Tgl Sample Jasa Komponen", formatter: value => moment(value).format("DD MMM YYYY") },
