...
export class List {
    ...
    columns = [
        { field: "ServiceSampleFabricWashNo", title: "No Sample Jasa Komponen" },
        { field: "UnitExpenditureNo", title: "No BUK" },
        { field: "ServiceSampleFabricWashDate", title: "Tgl Sample BB Fabric Wash / Print", formatter: value => moment(value).format("DD MMM YYYY") }
    ]
