...
var UnitReceiptNoteLoader = require("../../../loader/garment-subcon-unit-receipt-note-for-unit-delivery-order-loader");
      ...
      .then((result) => {
        if (result.data.length > 0) {
          ...
          for (var item of result.data) {
            ...
            Items.ProductRemark = `${item.POSerialNumber}; ${item.Article}; ${item.RONoMaster}; ${item.ProductRemark}`;
    ...
    if (newValue == null) {
      ...
      this.service
        ...
        .then((result) => {
          ...
          this.newProduct.RONo = selectedROHeader.RONoMaster;
          ...
          this.newProduct.ProductRemark = `${selectedROHeader.POSerialNumber}; ${selectedROHeader.Article}; ${selectedROHeader.RONoMaster}; ${selectedROHeader.ProductRemark}`;
