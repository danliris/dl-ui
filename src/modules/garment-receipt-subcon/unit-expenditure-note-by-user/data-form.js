...
var UnitDeliveryOrderLoader = require("../../../loader/garment-subcon-unit-delivery-order-for-unit-expenditure-note-loader");
...
export class DataForm {
  ...
  bind(context) {
    ...
    //     this.data.ExpenditureTo = "GUDANG LAIN";
    // }
    switch (this.data.ExpenditureType) {
      case "PROSES":
        this.data.ExpenditureTo = "PROSES";
        break;
      case "SEWING":
        this.data.ExpenditureTo = "SEWING";
        break;
      case "FINISHING":
