...
const CuttingInLoader = require("../../../../loader/garment-subcon-cutting-in-by-ro-loader");
...
export class DataForm {
  ...
  CuttingOutTypeOptions = ["SEWING", "PACKING", "LAINYYA"];
  ...
  async selectedCuttingInChanged(newValue, oldValue) {
    if (this.context.isCreate) {
      if (newValue) {
        ...
        let priceSewingResult = await this.service.getComodityPrice({
          filter: JSON.stringify({
            ComodityId: this.data.Comodity.Id,
