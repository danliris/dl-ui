...
const serviceUriPreparing = 'subcon-preparings';
// const hOrderKodeByNoServiceUri = 'local-merchandiser/horders/kode-by-no';
const costCalculationServiceUri = 'cost-calculation-garments';
const serviceUriCutting= 'receipt-subcon-cutting-outs/complete';
const serviceUriLoading= 'subcon-loading-outs/complete';
const serviceUriSewing = 'subcon-sewing-outs/complete';
const serviceUriFinishing = 'subcon-finishing-outs/complete';
const serviceUriExpenditure = 'subcon-packing-outs/complete';
