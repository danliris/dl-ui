  ...
  searching() {
    ...
    this.service.search(info).then((result) => {
      ...
      for (var _data of result) {
        ...
        _data._PriceCuttingOut = _data.PriceCuttingOut.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        ...
        _data._AvalSewingPrice = _data.AvalSewingPrice.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data._EndBalancCuttingeQty = _data.EndBalancCuttingeQty.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._QtyLoadingInTransfer = _data.QtyLoadingInTransfer.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._EndBalanceLoadingQty = _data.EndBalanceLoadingQty.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._WipFinishingOut = _data.WipFinishingOut.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data._WipFinishingOutPrice = _data.WipFinishingOutPrice.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._FinishingOutQty = _data.FinishingOutQty.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        ...
        _data._FinishingAdjQty = _data.FinishingAdjQty.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        ...
        _data._ExpenditureGoodRetur = _data.ExpenditureGoodRetur.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._PackingOutPrice = _data.PackingOutPrice.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
