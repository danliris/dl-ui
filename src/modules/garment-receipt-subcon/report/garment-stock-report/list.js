  ...
  searching() {
    ...
    this.service.search(args).then((result) => {
      ...
      for (var _data of result.data) {
        ...
        _data.BeginningBalanceQty = _data.BeginningBalanceQty.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        _data.ReceiptQty = _data.ReceiptQty.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data.ReceiptCorrectionQty = _data.ReceiptCorrectionQty.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        _data.ExpendQty = _data.ExpendQty.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data.EndingBalanceQty = _data.EndingBalanceQty.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
