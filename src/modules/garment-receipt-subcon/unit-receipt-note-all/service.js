...
const serviceUri = "garment-subcon-unit-receipt-notes";
...
export class Service extends RestService {
  ...
  //   return _endpoint.find(_serviceUri, { select: select }).then((result) => {
  //     return result.data;
  //   });
  // }
  ...
  //   return _endpoint.find(resource).then((result) => {
  //     return result.data;
  //   });
  // }
