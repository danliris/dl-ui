...
export class DataForm {
  ...
  typeUnitDeliveryOrderOptions = ["PROSES", "SISA", "SUBCON", "SAMPLE"]; //, 'SAMPLE'
  ...
  async searchRONo() {
    ...
    if (this.isTransfer) {
      ...
      this.service.getgarmentURNforUnitDO(info).then((results) => {
