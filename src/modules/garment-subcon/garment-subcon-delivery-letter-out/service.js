...
//Sample
const ServiceSubconSampleCuttingUri = "service-sample-cuttings";
const ServiceSubconSampleSewingUri = "service-sample-sewings";
const ServiceSubconSampleFabricUri = "service-sample-fabric-washes";
const ServiceSubconSampleShrinkageUri = "service-sample-shrinkage-panels";
const SubconSampleExpenditureGoodUri = "service-sample-expenditure-good";
...
class Service extends RestService {
  ...
  //Sample
  readServiceSubconSampleCuttingById(id) {
    var endpoint = `${ServiceSubconSampleCuttingUri}/${id}`;
    return super.get(endpoint);
  }

  readServiceSubconSampleSewingById(id) {
    var endpoint = `${ServiceSubconSampleSewingUri}/${id}`;
    return super.get(endpoint);
  }

  readServiceSubconSampleExpenditureGoodById(id) {
    var endpoint = `${SubconSampleExpenditureGoodUri}/${id}`;
    return super.get(endpoint);
  }

  readServiceSubconSampleShrinkageById(id) {
    var endpoint = `${ServiceSubconSampleShrinkageUri}/${id}`;
    return super.get(endpoint);
  }

  readServiceSubconSampleFabricById(id) {
    var endpoint = `${ServiceSubconSampleFabricUri}/${id}`;
    return super.get(endpoint);
  }
}
