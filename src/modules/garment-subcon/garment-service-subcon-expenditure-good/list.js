...
export class List {
  ...
  columns = [
    { field: "ServiceSubconExpenditureGoodNo", title: "No Subcon Jasa Barang Jadi" },
    {
      field: "ServiceSubconExpenditureGoodDate", title: "Tgl Subcon Jasa Barang Jadi", formatter: function (value, data, index) {
  ...
  loader = (info) => {
    ...
    var arg = {
      ...
      keyword: info.search,
      order: order,
      select: ["ServiceSubconExpenditureGoodNo", "ServiceSubconExpenditureGoodDate", "RONo", "Buyer.Name", "TotalQty", "Unit"],
    }
