...
export async function configure(aurelia) {
  aurelia.use
    ...
    .plugin("aurelia-api", config => {
      ...
      var productionAzure = "http://com-danliris-service-finishing-printing-dev.azurewebsites.net/v1/";
      ...
      var finance = "http://com-danliris-service-finance-accounting-dev.azurewebsites.net/v1/";
