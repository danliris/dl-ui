...
export async function configure(aurelia) {
  aurelia.use
    ...
    .plugin("aurelia-api", (config) => {
      ...
      // var core = "http://localhost:63479/v1/";
      var core = "https://com-danliris-service-core-dev.azurewebsites.net/v1/";
      // var purchasingAzure = "http://localhost:63153/v1/";
      var purchasingAzure =
        "https://com-danliris-service-purchasing-dev.azurewebsites.net/v1/";
      // var finance = "http://localhost:50043/v1/";
      var finance =
        "https://com-danliris-service-finance-accounting-dev.azurewebsites.net/v1/";
      ...
      var productionAzure =
        "https://com-danliris-service-finishing-printing-dev.azurewebsites.net/v1/";
      var purchasing = "https://dl-purchasing-webapi-dev.azurewebsites.net/v1/";
      var garmentPurchasing =
        "https://dl-purchasing-garment-webapi-dev.azurewebsites.net/v1/";
      var inventory = "https://dl-inventory-webapi-dev.azurewebsites.net/v1/";
      var inventoryAzure =
        "https://com-danliris-service-inventory-dev.azurewebsites.net/v1/";
      var garmentMasterPlan =
        "https://dl-garment-master-plan-webapi-dev.azurewebsites.net/v1/";
      var spMasterPlan =
        "https://dl-sp-master-plan-webapi-dev.mybluemix.net/v1/";
      var spinning =
        "https://com-danliris-service-spinning-dev.azurewebsites.net/";
      var intPurchasing =
        "https://com-danliris-service-internal-transfer-dev.azurewebsites.net/v1/";
      var customsReport =
        "https://com-danliris-service-support-dev.azurewebsites.net/v1/";
      var merchandiser =
        "https://com-danliris-service-md-dev.azurewebsites.net/v1/";
      const dealTracking =
        "https://com-danliris-service-deal-tracking-dev.azurewebsites.net/v1/";
      const sales =
        "https://com-danliris-service-sales-dev.azurewebsites.net/v1/";
      var weaving =
        "https://com-danliris-service-weaving-dev.azurewebsites.net/";
      var garmentProduction =
        "https://com-danliris-service-garment-dev.azurewebsites.net/";
      var packingInventory =
        "https://com-danliris-service-packing-inventory-dev.azurewebsites.net/v1/";
