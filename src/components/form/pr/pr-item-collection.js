...
import PrItemCollectionReact from '../../react/pr/pr-item-collection-react.jsx';


@noView()
@inject(Element)
@customElement('pr-item-collection')
export class PoItemCollection {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <PrItemCollectionReact value={this.value} error={this.error} options={this.options}></PrItemCollectionReact>,
            this.element
        );
    }
