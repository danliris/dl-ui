...
import MaterialByProcessTypeAutoSuggestReact from '../../react/auto-suggests/material-by-process-type-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('material-by-process-type-auto-suggest')
export class MaterialByProcessTypeAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <MaterialByProcessTypeAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange}/>
            </FieldReact>,
            this.element
        );
    }
