...
import UsterAutoSuggestReact from '../../react/auto-suggests/uster-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('uster-auto-suggest')
export class UsterAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <UsterAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
