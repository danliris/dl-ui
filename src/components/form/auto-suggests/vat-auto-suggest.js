...
import VatAutoSuggestReact from '../../react/auto-suggests/vat-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('vat-auto-suggest')
export class VatAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <VatAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
