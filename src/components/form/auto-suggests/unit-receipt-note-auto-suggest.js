...
import UnitReceiptNoteAutoSuggestReact from '../../react/auto-suggests/unit-receipt-note-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('unit-receipt-note-auto-suggest')
export class UnitReceiptNoteAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <UnitReceiptNoteAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
