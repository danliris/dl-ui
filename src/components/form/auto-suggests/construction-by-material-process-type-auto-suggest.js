...
import ConstructionByMaterialProcessTypeAutoSuggestReact from '../../react/auto-suggests/construction-by-material-process-type-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('construction-by-material-process-type-auto-suggest')
export class ConstructionByMaterialProcessTypeAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <ConstructionByMaterialProcessTypeAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange}/>
            </FieldReact>,
            this.element
        );
    }
