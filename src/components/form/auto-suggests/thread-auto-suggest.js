...
import ThreadAutoSuggestReact from '../../react/auto-suggests/thread-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('thread-auto-suggest')
export class ThreadAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <ThreadAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
