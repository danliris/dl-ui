...
import UnitByDivisionAutoSuggestReact from '../../react/auto-suggests/unit-by-division-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('unit-by-division-auto-suggest')
export class UnitByDivisionAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <UnitByDivisionAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
