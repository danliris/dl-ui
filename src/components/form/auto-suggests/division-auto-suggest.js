...
import DivisionAutoSuggestReact from '../../react/auto-suggests/division-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('division-auto-suggest')
export class DivisionAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <DivisionAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
