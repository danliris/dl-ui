...
import LampStandardAutoSuggestReact from '../../react/auto-suggests/lamp-standard-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('lamp-standard-auto-suggest')
export class LampStandardAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <LampStandardAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
