...
import BuyerAutoSuggestReact from '../../react/auto-suggests/buyer-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('buyer-auto-suggest')
export class BuyerAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <BuyerAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
