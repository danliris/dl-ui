...
import MachineByUnitAutoSuggestReact from '../../react/auto-suggests/machine-by-unit-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('machine-by-unit-auto-suggest')
export class MachineByUnitAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <MachineByUnitAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange}/>
            </FieldReact>,
            this.element
        );
    }
