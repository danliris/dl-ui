...
import BudgetAutoSuggestReact from '../../react/auto-suggests/budget-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('budget-auto-suggest')
export class BudgetAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <BudgetAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
