...
import MachineAutoSuggestReact from '../../react/auto-suggests/machine-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('machine-auto-suggest')
export class MachineAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <MachineAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
