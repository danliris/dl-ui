...
const resource = 'finishing-printing/production-orders';
        ...
        suggestions: function (keyword, filter) {
            ...
            return endpoint.find(resource, { keyword: keyword, filter: JSON.stringify(filter) })
                .then(results => 
                {
                    ...
                    for(var salesContract of results.data){
                        for(var productionOrder of salesContract.productionOrders){
                            productionOrders.push(productionOrder);
                        }
                    }

                    return productionOrders.map(productionOrder => {
                        productionOrder.toString = function(){
                            return `${this.orderNo}`;  
                        }
