...
import PrItemReact from './pr-item-react.jsx';

'use strict';

export default class PrItemCollectionReact extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        var items = (this.state.value || []).map(function (item, index) {
            ...
            return (
                <PrItemReact key={"__item" + index} value={item} error={error} options={this.state.options} onRemove={this.handleItemRemove}></PrItemReact>
            );
        }.bind(this))
