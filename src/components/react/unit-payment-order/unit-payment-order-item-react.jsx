...
import UnitReceipNoteBySupplierUnitAutoSuggestReact from '../auto-suggests/unit-receipt-note-by-supplier-unit-auto-suggest-react.jsx';
                            ...
                            <tr>
                                <td width="90%">
                                    <div className={`form-group ${this.state.error.no ? 'has-error' : ''}`}style={style}>
                                        <UnitReceipNoteBySupplierUnitAutoSuggestReact value={unitReceiptNote} options={this.state.options} onChange={this.handleUnitReceiptNoteChange} />
